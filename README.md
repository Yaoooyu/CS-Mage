...
The dataset package is distributed separately from this code repository.
...
The data files are obtained through the links above and remain subject to the
data-use conditions documented in this repository.
...
Citation information will be added after publication. The repository includes
only materials that may be distributed with this project; obtain third-party
baseline implementations, source media, and pretrained checkpoints through
their original distribution channels and licenses.
