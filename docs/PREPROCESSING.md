...
frames (347-D). The repository retains the fold builder and BERT-input helper.
...
Use OpenFace 2.0 to generate the visual features required by the documented
347-dimensional interface.
