...
Before publication, export these entries into the manuscript's canonical `.bib` file and verify author spelling, venues, pages, and upstream licenses against the linked primary source.
