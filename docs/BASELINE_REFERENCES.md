...
> All baselines were evaluated under the same fixed sample-ID reconstructed
> five-fold protocol and unified metric implementation. Official
> implementations were reused whenever available, while unavailable methods
> were reproduced following their published descriptions.
